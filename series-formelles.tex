...
\begin{ex} \label{ex:endofunctions}
  ...
  \begin{commentary}
    Illustrate transport for endofunctions?  XXX pictures illustrating
    permutations, connected endofunctions, circular permutations,
    contraction.  Need facility for drawing labelled graphs!
  \end{commentary}
\end{ex}
