...
``structures'' containing some sort of ``atoms'' or ``elements''.
...
consists of things like \todo{picture} (To start, we will suppose that
the ``atoms''---indicated by dots in the diagram above---are
indistinguishable; there will be much more to say about this later.)

Combinatorial classes can be combined in various algebraic ways.  For
example, the \emph{product} of two classes consists of the set of all
\emph{ordered pairs} of structures from the two classes; the
\emph{sum} consists of the disjoint union of the two sets of
structures; and so on.  If there are a finite number of structures in
each class, such operations correspond to \todo{continue}
