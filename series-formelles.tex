...
trees, which is certainly not finite.  But how can we continue to do
...
XXX Now restrict to \term{finitary} classes, which have
a finite number \emph{of each size} (but may be infinite overall).
Then keep track not of total number of structures, but number of
structures of each size, $|F|_n$.
\begin{itemize}
