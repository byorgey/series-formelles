...
dia = mconcat
  ...
  since one can obtain a rooted tree from a tree just by picking a
  distinguished root node; this will be explored in more detail later.
\end{commentary}
\end{ex}


\begin{ex} \label{ex:endofunctions}
  The transport of an endofunction $\phi : E \to E$ along a bijection $u
  ...
  \begin{commentary}
    ...
    Intuitively, (almost\footnote{As long as it is \term{finitary}.})
    \emph{any} type built out of products, coproducts, and functions
    will define a valid species. \todo{mention HoTT transport}
