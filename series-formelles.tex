...
\[ u : s \to t. \]
\begin{commentary}
  These next sentences have to do with the second component of a
  functor, the morphism mapping which sends morphisms to morphisms.
  In this case, $M$ sends bijections between label sets
