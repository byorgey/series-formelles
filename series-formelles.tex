...
dia = mconcat
  ...
  \end{diagram}
  \end{center}
  XXX this is a graphical representation of the simplicial scheme XXX ...

  Simplicial schemes, seeing as they consist simply of collections of
  subsets of the underlying label type $E$, can clearly be
  functorially relabelled---just apply the relabelling to each subset.
