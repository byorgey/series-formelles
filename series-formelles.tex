...
\begin{commentary}
  ...
  some other labels.  Apparently, in (most?) previous treatments this
  was taken as something secondary, a desideratum to be verified after
  each definition; Joyal's insight is to make transport itself the
  central defining feature of species.
\end{commentary}
